...
class Follower:
        ...
        def image_callback(self, msg):
                ...
                if M['m00'] > 0:
                        ...
                        if(thistime-self.starttimer>80 and self.right==0 and M3['m00']<=0 and self.finish==0):
                                self.right=1
                        if(self.right==1):
                        ...
                        err = w/2 -10 - fx
                        # print("Error:",err,"fx",fx)
                        # if cy1<=200:

                        self.twist.linear.x = 0.20
                        self.twist.angular.z = (err*90.0/160)/6
                        ...
                        matrix = numpy.array([[251.90279,0.,162.34701],
                                        [0.,251.36665,127.8276],
                                        [0.,0.,1.]])
