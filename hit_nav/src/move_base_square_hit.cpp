...
geometry_msgs::Pose pose_list[11];  //a pose consisting of a position and orientation in the map frame.
...
void init_goalList()
{
	...
	point = setPoint(0.177, -3.492, 0.000);
	quaternions = setQuaternion( -0.013 );
	pose_list[0].position = point;
	pose_list[0].orientation = quaternions;

	point = setPoint(0.801, -3.471, 0.000);
	quaternions = setQuaternion( -0.057);
	pose_list[1].position = point;
	pose_list[1].orientation = quaternions;

	point = setPoint(3.587, -4.419, 0.000);
	quaternions = setQuaternion( 1.661 );
	pose_list[2].position = point;
	pose_list[2].orientation = quaternions;

	point = setPoint(1.729, -2.236, 0.000);
	quaternions = setQuaternion( 1.557 );
	pose_list[3].position = point;
	pose_list[3].orientation = quaternions;

	point = setPoint(1.865, -0.347, 0.000);
	quaternions = setQuaternion( 1.540 );
	pose_list[4].position = point;
	pose_list[4].orientation = quaternions;

	point = setPoint(3.917, -0.488, 0.000);
	quaternions = setQuaternion( -1.641  );
	pose_list[5].position = point;
	pose_list[5].orientation = quaternions;

	//point = setPoint(1.865, -0.347, 0.000);
	//quaternions = setQuaternion( 1.540 );
	//pose_list[6].position = point;
	//pose_list[6].orientation = quaternions;

	point = setPoint(-0.208, -0.163, 0.000);
	quaternions = setQuaternion( 3.041  );
	pose_list[6].position = point;
	pose_list[6].orientation = quaternions;

	point = setPoint(1.934, -0.823, 0.000);
	quaternions = setQuaternion( -1.641  );
	pose_list[7].position = point;
	pose_list[7].orientation = quaternions;

	point = setPoint(1.595, -3.611, 0.000);
	quaternions = setQuaternion( 3.037  );
	pose_list[8].position = point;
	pose_list[8].orientation = quaternions;

	point = setPoint(0.369, -3.555, 0.000);
	quaternions = setQuaternion( -2.544  );
	pose_list[9].position = point;
	pose_list[9].orientation = quaternions;

	//point = setPoint(0.801, -3.471, 0.000);
	//quaternions = setQuaternion( -2.544  );
	//pose_list[10].position = point;
	//pose_list[10].orientation = quaternions;

	point = setPoint(-0.666, -4.170, 0.000);
	quaternions = setQuaternion( 3.112  );
	pose_list[10].position = point;
	pose_list[10].orientation = quaternions;
}
